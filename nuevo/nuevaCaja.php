    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <section class="page-content">
                ...
                <nav class="page-tabs">
                    <ul>
                        <li><a href="nuevaCaja.php" class="tab-active"><span class="icon"></span> NUEVA CAJA</a></li>
                        <li><a href="listaCajas.php"><span class="icon"></span> LISTA DE CAJAS</a></li>
                    </ul>
                </nav>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="input-with-icon">
                                    <input type="text" id="numero_caja" name="numero_caja" value="" placeholder="Asignado automaticamente" disabled>
